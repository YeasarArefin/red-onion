                ...
                <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            <li>
                                <a className="text-white hover:text-gray-800">First a</a>
                            </li>
                            <li>
                                <a className="text-white hover:text-gray-800">Second a</a>
                            </li>
                            <li>
                                <a className="text-white hover:text-gray-800">Third a</a>
                            </li>
                            <li>
                                <a className="text-white hover:text-gray-800">Fourth a</a>
                            </li>
                        </nav>
                    </div>
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
